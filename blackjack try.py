...
class Start_Home(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, size=(300, 300))
        ...
        stand_button = wx.Button( id=-1, label='Stand', pos=(10, 300), size=(175, 28))
        hit_button = wx.Button( id=-1, label='Hit', pos=(200, 300 ), size=(175, 28))
        reset_button = wx.Button(id=-1, label='Next Round', pos=(400, 300 ), size=(175, 28))
